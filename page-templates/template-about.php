        ...
        <section class="headings">
            <div class="text-heading text-center">
                <div class="container">
                    ...
                    <h2><a href="<?php echo site_url(); ?>">Home </a> &nbsp;/&nbsp; About Us</h2>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 col-md-12 who-1">
                        ...
                        <div class="box bg-2">
                            <a href="<?php echo site_url(); ?>/about" class="text-center button button--moema button--text-thick button--text-upper button--size-s">read More</a>
                            <img src="<?php echo get_theme_file_uri(); ?>/assets/images/signature.png" class="ml-5" alt="">
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-12 col-xs-12">
                        <div class="wprt-image-video w50">
                            <img alt="image" src="<?php echo get_theme_file_uri(); ?>/assets/images/bg/bg-video.jpg">
            ...
            <div class="container">
                ...
                <div class="row team-all">
                    <div class="col-lg-3 col-md-6 team-pro">
                        <div class="team-wrap">
                            <div class="team-img">
                                <img src="<?php echo get_theme_file_uri(); ?>/assets/images/team/t-5.jpg" alt="" />
                            </div>
                    ...
                    <div class="col-lg-3 col-md-6 team-pro">
                        <div class="team-wrap">
                            <div class="team-img">
                                <img src="<?php echo get_theme_file_uri(); ?>/assets/images/team/t-6.jpg" alt="" />
                            </div>
                            <div class="team-content">
                                <div class="team-info">
                                    <h3>Arling Tracy</h3>
                    ...
                    <div class="col-lg-3 col-md-6 team-pro pb-none">
                        <div class="team-wrap">
                            <div class="team-img">
                                <img src="<?php echo get_theme_file_uri(); ?>/assets/images/team/t-7.jpg" alt="" />
                            </div>
                            <div class="team-content">
                                <div class="team-info">
                                    <h3>Mark Web</h3>
                    ...
                    <div class="col-lg-3 col-md-6 team-pro kat">
                        <div class="team-wrap">
                            <div class="team-img">
                                <img src="<?php echo get_theme_file_uri(); ?>/assets/images/team/t-8.jpg" alt="" />
                            </div>
                            <div class="team-content">
                                <div class="team-info">
                                    <h3>Katy Grace</h3>
        ...
        <div class="partners bg-white-2">
            <div class="container">
                ...
                <div class="owl-carousel style2">
                    <div class="owl-item"><img src="<?php echo get_theme_file_uri(); ?>/assets/images/partners/11.jpg" alt=""></div>
                    <div class="owl-item"><img src="<?php echo get_theme_file_uri(); ?>/assets/images/partners/12.jpg" alt=""></div>
                    <div class="owl-item"><img src="<?php echo get_theme_file_uri(); ?>/assets/images/partners/13.jpg" alt=""></div>
                    <div class="owl-item"><img src="<?php echo get_theme_file_uri(); ?>/assets/images/partners/14.jpg" alt=""></div>
                    <div class="owl-item"><img src="<?php echo get_theme_file_uri(); ?>/assets/images/partners/15.jpg" alt=""></div>
                    <div class="owl-item"><img src="<?php echo get_theme_file_uri(); ?>/assets/images/partners/16.jpg" alt=""></div>
                    <div class="owl-item"><img src="<?php echo get_theme_file_uri(); ?>/assets/images/partners/17.jpg" alt=""></div>
                    <div class="owl-item"><img src="<?php echo get_theme_file_uri(); ?>/assets/images/partners/11.jpg" alt=""></div>
                    <div class="owl-item"><img src="<?php echo get_theme_file_uri(); ?>/assets/images/partners/12.jpg" alt=""></div>
                    <div class="owl-item"><img src="<?php echo get_theme_file_uri(); ?>/assets/images/partners/13.jpg" alt=""></div>
                </div>
